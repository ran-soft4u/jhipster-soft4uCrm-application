...
@RestController
@RequestMapping("/api/jhipster-soft-4-u-crm-application-kafka")
public class JhipsterSoft4UCrmApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSoft4UCrmApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSoft4UCrmApplicationKafkaResource(KafkaProperties kafkaProperties) {
