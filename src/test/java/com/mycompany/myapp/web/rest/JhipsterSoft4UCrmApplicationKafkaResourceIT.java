...
class JhipsterSoft4UCrmApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSoft4UCrmApplicationKafkaResource kafkaResource = new JhipsterSoft4UCrmApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-soft-4-u-crm-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-soft-4-u-crm-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
